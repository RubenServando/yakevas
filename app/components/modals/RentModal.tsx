...
const RentModal = () => {
    ...
    let bodyContent = (
        <div className="flex flex-col gap-8">
            <Heading 
                title="Which describes your transportation?"
    ...
    if (step === STEPS.LOCATION) {
        bodyContent = (
            <div className="flex flex-col gap-8">
                <Heading 
                    title="Where is your transportation located?"
                    subtitle= "Help interested people find you!"
                />
                <CountrySelect
                    value={location}
    ...
    if (step === STEPS.DESCRIPTION) {
        bodyContent = (
            <div className="flex flex-col gap-8">
                <Heading
                    title="How you describe your transportation?"
        ...
        bodyContent = (
            <div className="flex flex-col gap-8">
                <Heading 
                    ...
                    subtitle="How much do you charge per transport?"
                />
                <Input 
                    id="price"
                    label="Price"
